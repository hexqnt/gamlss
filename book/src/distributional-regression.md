...
У каждого параметра могут быть собственные признаки, коэффициенты и штрафы(penalty). Например, признаки, влияющие на средний уровень, не обязаны совпадать с признаками, влияющими на разброс.
