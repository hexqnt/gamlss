...
Experimental optional formula/builder layer for compiling user specifications into typed `gamlss-core` models.

`gamlss-formula` is not the primary API of the project. The main direction is the lower-level typed stack: `gamlss-core`, `gamlss-family`, `gamlss-spline`, and `gamlss-transform`.
