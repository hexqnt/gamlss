...
pub use univariate::{
    ...
    ShashMuSigmaNuTau, ShashTheta, SkewNormal, SkewNormalEta, SkewNormalMeanSd,
    ...
    StudentTMuSigmaTauTheta, StudentTStdDev, StudentTTheta, Tweedie, TweedieCv, TweedieEta,
    TweedieMeanCvPower, TweedieMeanCvPowerEta, TweedieMeanCvPowerTheta, TweedieMeanDispersionPower,
    TweedieTheta, Weibull, WeibullMeanShape, WeibullMeanShapeEta, WeibullMeanShapeTheta,
    WeibullScaleShape, WeibullScaleShapeEta, WeibullScaleShapeTheta, Zaga,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        RayleighTheta, Shash, ShashEta, ShashMuSigmaNuTau, ShashTheta, SkewNormal, SkewNormalEta,
