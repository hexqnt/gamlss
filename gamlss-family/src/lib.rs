...
pub use univariate::{
    ...
    ZagaTotalMeanCvZeroProbabilityEta, ZagaTotalMeanCvZeroProbabilityTheta, ZeroAdjustedStudentT,
    ZeroAdjustedStudentTEta, ZeroAdjustedStudentTMuSigma, ZeroAdjustedStudentTTheta, Zinb,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        ZagaTotalMeanCvZeroProbabilityTheta, ZeroAdjustedStudentT, ZeroAdjustedStudentTEta,
        ZeroAdjustedStudentTMuSigma, ZeroAdjustedStudentTTheta, Zinb,
        ZinbComponentMeanSizeZeroProbability, ZinbComponentMeanSizeZeroProbabilityEta,
        ZinbComponentMeanSizeZeroProbabilityTheta, ZinbTotalMeanSizeZeroProbability,
        ZinbTotalMeanSizeZeroProbabilityEta, ZinbTotalMeanSizeZeroProbabilityTheta, Zip,
        ZipComponentMeanZeroProbability, ZipComponentMeanZeroProbabilityEta,
