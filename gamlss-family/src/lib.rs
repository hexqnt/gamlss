...
pub use univariate::{
    ...
    ExponentialRateTheta, Gamma, GammaMeanCv, GammaMeanCvEta, GammaMeanCvTheta, GammaMeanShape,
    ...
    InverseGaussianMuShape, InverseGaussianTheta, JohnsonSu, JohnsonSuEta, JohnsonSuMuSigmaNuTau,
    JohnsonSuTheta, Laplace, LaplaceEta, LaplaceMuSigma, LaplaceTheta, LogNormal,
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        ExponentialRateEta, ExponentialRateTheta, FactorizedComponentGradient, Gamma, GammaMeanCv,
        GammaMeanCvEta, GammaMeanCvTheta, GammaMeanShape, GammaMeanShapeEta, GammaMeanShapeTheta,
        GammaShapeRate, GammaShapeRateEta, GammaShapeRateTheta, Ged, GedMuSigmaNu,
        GeneralizedGamma, GeneralizedGammaEta, GeneralizedGammaScaleSigmaNu, GeneralizedGammaTheta,
        Gev, GevEta, GevMuSigmaShape, GevTheta, Gumbel, GumbelEta, GumbelMuSigma, GumbelTheta,
        ...
        Laplace, LaplaceEta, LaplaceMuSigma, LaplaceTheta, LogNormal, LogNormalLogLocationLogSd,
        LogNormalLogLocationLogSdEta, LogNormalLogLocationLogSdTheta, LogNormalMeanCv,
        LogNormalMeanCvEta, LogNormalMeanCvTheta, LogNormalMeanLogSd, LogNormalMeanLogSdEta,
        LogNormalMeanLogSdTheta, LogNormalMedianLogSd, LogNormalMedianLogSdEta,
        LogNormalMedianLogSdTheta, Logistic, LogisticEta, LogisticMuSigma, LogisticTheta, Lomax,
        LomaxEta, LomaxShapeScale, LomaxTheta, Mixture, MixtureEta, MixtureGradient, MixtureTheta,
...
mod initializer_tests {
    ...
    use crate::{
        ...
        ZagaComponentMeanCvZeroProbability, ZinbComponentMeanSizeZeroProbability,
        ZipComponentMeanZeroProbability,
    };
